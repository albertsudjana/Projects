...
(begin (define x 3) (* x x))
; expect 9

(begin (define x 3) (define x 2) (+ x 2))
; expect 4

(begin (print 2) 3)
; prints 2 and returns 3

(lambda (a b) (* a (+ a b)))
; prints (lambda (a b) (* a (+a b)))
...
(let ((a (lambda (b c) (+ b c))) (d 10) (e 13)) (a d e))
; expect 23
